...
//first gab (first floor)
   if ((Xplayer <= 209 || Xplayer >= 249 || Yplayer < 570 || Yplayer > 380)) {Yplayer =+ Yplayer;}
   else Yplayer =- 30;
   
//second gab (first floor)
   if ((Xplayer <= 459 || Xplayer >= 649 || Yplayer < 570 || Yplayer > 380)) {Yplayer =+ Yplayer;}
   else Yplayer =- 30;  

}

void secondFloor() {
//so player doesn't move throught wall
   if ((Xplayer > 960) && (Yplayer > 365)) {Xplayer = 970;}
   else Xplayer -= 0;

//so player can stand on secondd floor) 
   if ((Xplayer <= 1000 || Yplayer > 380)) {Yplayer =+ Yplayer;}
   else Yplayer += 365;
   
   if ((Xplayer <= 1000 || Yplayer > 380)) {Xplayer =+ Xplayer;}
   else Xplayer += 970;
   
// zero platform (second floor) 
   if ((Xplayer <= 1000 || Yplayer > 380)) {Yplayer =+ Yplayer;}
   else Yplayer += 365;
   
// first gab (second floor) 
   if ((Xplayer <= 960) && (Yplayer > 380)) {Yplayer =+ Yplayer;}
   else Yplayer = 365;

// first platform (second floor) 
   if ((Xplayer <= 800) && (Xplayer >= 900 || Yplayer > 385)) {Yplayer =+ Yplayer;}
   else Yplayer = 365;
   
// second gab (second floor) 
   if ((Xplayer <= 575) && (Xplayer >= 720 || Yplayer > 385)) {Yplayer =+ Yplayer;}
   else Yplayer = 365;

// thrid platform (second floor) 
   if ((Xplayer <= 300) && (Xplayer >= 450 || Yplayer > 385)) {Yplayer =+ Yplayer;}
   else Yplayer = 365;
...
// making the player able to climb
  ...
  else if ((climbPressed == true) && (Xplayer >= 990)) {climb = false;}
