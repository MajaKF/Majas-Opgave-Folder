...
//so player doesn't move throught wall
   ...
   if ((Xplayer < 20) && (Yplayer > 380)) {Xplayer = 30;}
   else Xplayer -= 0;
   
// zero platform (second floor) 
   if ((Xplayer <= 960 || Yplayer > 385)) {Yplayer =+ Yplayer;}
   else Yplayer += 365;
...
// making the player able to climb
  if ((climbPressed == true) && (Xplayer >= 960) && (Yplayer >= 570)) {climb = true;}
  else climb = false;
